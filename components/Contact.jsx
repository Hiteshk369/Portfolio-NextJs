...
const Contact = () => {
  ...
  return (
    <div id='contact' className="w-full md:h-screen p-2 flex items-center md:py-16 py-14 ">
      <div className="max-w-[1240px] mx-auto w-full ">
        <p className="md:mx-0 mx-3 uppercase text-xl font-poppins tracking-widest pb-4">
          Contact
        </p>
        <h2 className="md:mx-0 mx-3 font-poppins md:text-4xl text-2xl tracking-wide">Love to hear from you,</h2>
        <h2 className="md:mx-0 mx-3 font-poppins md:text-4xl text-2xl py-1 pb-4 tracking-wide">Get In Touch</h2>
        <form onSubmit={handleOnSubmit}>
          ...
          <div className="pt-3 md:mx-0 mx-3">
            ...
            >
             <p className="flex items-center justify-center flex-1 gap-2">SUBMIT <BsArrowUpRight />  </p>
            </button>
          </div>
        </form>
        {status.info.error && (
      ...
      {!status.info.error && status.info.msg && <p className="font-poppins text-gray-700 md:pt-3 pt-5 md:text-base text-sm md:mx-0 mx-3">{status.info.msg}</p>}
      </div>
    </div>
  );
};
