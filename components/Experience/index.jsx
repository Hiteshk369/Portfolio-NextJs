          ...
          <div className=" mt-2 flex items-center justify-center ">
            ...
            >
              <div className="absolute w-[100%] h-[35%] bg-gradient-to-tr from-orange-400 to-orange-700 flex items-center justify-center ">
                <p className="font-poppins text-xl font-semibold text-slate-200 ">
                  The Tann Mann Gaadi
                </p>
              </div>
              ...
              <div className="absolute top-[45%] h-full w-full flex justify-center">
                <div className="flex flex-col items-center">
                  <p className="font-poppins text-xl font-semibold dark:text-darkHeading">
                    Mern Stack Developer Intern
                  </p>
                  <p className="font-poppins font-medium dark:text-slate-200">
                    Jan 2023 - May 2023
                  </p>
                  <div className="w-full flex flex-col items-center justify-center px-5 pt-3 space-y-2">
                    <p className="font-poppins text-xs leading-4 text-gray-500 dark:text-darkText">
